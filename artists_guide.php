...
<body class="guide-background">
           ...
           <p class="word2">
                        1. Register and upload your artwork on <a style="color:#f2f2f2;" href="home.php">ART EASY.</a><br>
                        2. Ship the artwork to the buyer.<br>
                        3. Receive 80% of the selling price.<br>
            </p>

            <h3 class="word1">How do I apply to exhibit my artwork at ART EASY?</h3>
            ...
            <h3 class="word1">What is your commission structure?</h3>
                <p class="word2"> Art EASY Gallery will pay you 80% of the selling price.  Pay for shipping and get your profit!<br><br>
            ...
            <h3 class="word1" >Where is ART EASY based?</h3>
                <p class="word2">Our main office is located in BUCS, Legazpi city, although we are primarily a virtual gallery.</p>

            <h3 class="word1">If I exhibit my work at ART EASY, may I seek other gallery representation?</h3>
                <p class="word2">Yes.</p>
            ...
            <h3 class="word1">Can clients living outside of the United States purchase my art on ART EASY?</h3>
                <p class="word2">No! We don't allow international customers.</p>

            <h3 class="word1">How do I submit more art if I am already exhibiting my work at ART EASY?</h3>
